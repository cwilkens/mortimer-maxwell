...
Menu::Menu(Console &parent)
{
	...
	// mode menu
	menu_data.push_back(tmpV);
	menu_data[1].push_back("Manual");
	menu_data[1].push_back("Colors");
	menu_data[1].push_back("Text");
	menu_data[1].push_back("Select");
	menu_data[1].push_back("Frame");
	// frame menu
	menu_data.push_back(tmpV);
	menu_data[2].push_back("Next");
	menu_data[2].push_back("Back");
	menu_data[2].push_back("Insert");
	menu_data[2].push_back("Copy");
	menu_data[2].push_back("Delete");
